"""
原始版本，没有把基本功能抽象成基类并继承改写。建议继承ModelBase类改写数据集生成和模型实现。
建议不再直接使用此文件,而是使用继承ModelBase的ModelZoo中的模型类
"""
...
if __name__ == '__main__':
    ...
    mcf = MatrixCF(feature_dims=args.feature_dims, embedding_size=args.embedding_size, lr=args.lr,
